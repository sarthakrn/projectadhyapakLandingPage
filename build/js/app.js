      ...
      x = function () {
        function t(e, n) {
          if (function (t, e) {
            ...
            if (this.elements = s(e), this.defaults = {
              delay: 0,
              orientation: "up",
              scale: 1.3,
              overflow: !1,
              ...
              var o = p(s(this.settings.customContainer), 1);
        ...
        return e = t, (n = [{
          ...
          value: function () {
            var t = this;
            r.setViewportAll(this.customContainer), T = [].concat(m(this.elements.map(function (e) {
          ...
          value: function () {
            var t = this;
            r.setViewportTop(this.customContainer), this.lastPosition !== r.positions.top ? (r.setViewportBottom(), T.forEach(function (e) {
              t.proceedElement(e);
